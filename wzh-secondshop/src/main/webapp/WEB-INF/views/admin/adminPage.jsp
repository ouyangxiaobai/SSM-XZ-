...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" style="font-size: 25px">校园闲置商品交易平台后台管理</a>
		</div>
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a
					href="/admin/adminLogout?adminLogout=true">退出</a></li>
			</ul>
		</div>
	</div>
	</nav>
    ...
    function deleteFirst(first_id) {
        $.getJSON("/type/firstType/delete/"+first_id, function (data) {
            if (data === false){
    ...
    function deleteSecond(second_id) {
        $.getJSON("/type/secondType/delete/"+second_id, function (data) {
            if (data === false){
    ...
    function firstButton(first_id) {
        ...
        $.getJSON("/type/secondType/"+first_id, function (data) {
            if (data === false){
                alert("好像出了问题，请重试！")
            } else if (data === "isNull") {
                alert("该分类下暂无分类！")
    ...
    function setUserStatus(statusId, userId) {
        $.getJSON("/admin/user/update/status/"+statusId+"&"+userId, function (data) {
            if (data === false){
                alert("用户状态修改失败！");
            } else {
    ...
    function delUser(userId) {
        $.getJSON("/admin/user/delete/"+userId, function (data) {
            if (data === false){
                alert("用户删除失败！");
            } else {
                document.getElementById("userTable").innerHTML = "";
    ...
    function delOrder(orderId) {
        $.getJSON("/user/order/delete/"+orderId, function (data) {
            if (data){
                $.getJSON("/user/order/allOrder", function (data) {
    ...
    function delGood(goodId) {
        $.getJSON("/goods/userGoodEdit/delete/"+goodId, function (data) {
            if (data){
                $.getJSON("/admin/goods/allGoods", function (data) {
    ...
    function setStatus(goodId) {
        $.getJSON("/goods/userGoodEdit/updateGoodStatus/"+goodId, function (data) {
            if (data){
                $.getJSON("/admin/goods/allGoods", function (data) {
                    document.getElementById("goodTable").innerHTML = "";
                    $.each(data, function (i, type) {
