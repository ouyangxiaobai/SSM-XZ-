				...
				<div class="col-md-12" style="margin-top: 40px;">
					...
					<div class="col-md-5">
						...
						<div class="col-md-12" style="padding: 0px">
							...
							<c:choose>
								<c:when test="${goodInfo.statusId == 1}">
									...
									<a
										style="display: ${sessionScope.user.id == goodInfo.goodUser.id ? '':'none'}"
										href="/goods/userGoodEdit?goodId=${goodInfo.id}">
						...
						<div class="col-md-12" style="margin-top: 50px" align="right">
							<p>
								<a
									href="/goods/userGoods?userId=${goodInfo.userId}">查看卖家其他物品</a>
							</p>
						</div>
					</div>
				</div>
						...
						<c:forEach var="review" items="${reviews}">
							<div class="col-md-12 r"
								...
								<div id="${review.id}" class="col-md-12"
									...
									<form action="/goods/goodInfo" method="post">
										<div class="col-sm-10">
        ...
        $.ajax({
            ...
            success:function (data) {
                if (data === false){
                    ...
                    alert("收藏成功！");
                    $(window).attr('location','/goods/goodInfo?goodId=${goodInfo.id}');
                }
            }
        })
    }
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data === false){
                        ...
                        $(window).attr('location','/user/orderInfo?orderId=' + data);
                    }
                }
            });
        }
